...
public class ModelCalculation {
    private String timestamp,completed,cancelled,deliveryFeeFullDay,shopName,fullAddress,inProgress,totalOfCompleted,totalOfCancelled,totalOfCost,totalOfInProgress,shopDeliveryFee,shopUid;

    public ModelCalculation() {
    }

    public ModelCalculation(String timestamp, String completed, String cancelled, String deliveryFeeFullDay, String shopName, String fullAddress, String inProgress, String totalOfCompleted, String totalOfCancelled, String totalOfCost, String totalOfInProgress, String shopDeliveryFee, String shopUid) {
