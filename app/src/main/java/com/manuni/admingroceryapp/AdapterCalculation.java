...
import com.manuni.admingroceryapp.databinding.CalculationRowBinding;
...
public class AdapterCalculation extends RecyclerView.Adapter<AdapterCalculation.AdapterCalculationViewHolder> implements Filterable {
    ...
    @Override
    public void onBindViewHolder(AdapterCalculationViewHolder holder, int position) {
        ...
        holder.binding.dateTimeTV.setText(dateTime);
